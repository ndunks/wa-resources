...
__d(
  ...
  function (a, b, c, d, e, f) {
    a = Object.freeze({
      NONE: 0,
      GENERIC_COMET_DO_NOT_USE: 1,
      COMET_ON_MOBILE: 2,
      COMET_ON_INSTAGRAM_DO_NOT_USE: 3,
      ...
      WHATSAPP_FLOWS: 68,
      GENERATIVE_OFFENSIVE_ASSESSMENT_TOOL: 69,
      SHOPIFY_APP: 70,
      LLAMA_DEV_CENTER: 71,
      KADABRA: 72,
      THREADS_FAMILY_CENTER: 73,
      PAYMENTS: 74,
      HORIZON_MANAGED_SOLUTIONS: 75,
      TEST_COMET: 76,
      WHATSAPP_MINIAPPS: 77,
      META_ACCOUNT_AUTH: 78,
      DEV_HUB: 79,
      THREADS_ACCOUNTS_CENTER: 80,
      SHOPIFY_WHATSAPP_APP: 81,
      WILDFLOWER: 82,
      FAMILY_CENTER_MARKETING: 83,
      CONSENT_TEMPLATES: 84,
      FB_COMMUNITY_NOTES: 85,
      WEARABLES_DEV_CENTER: 86,
      AI_META: 87,
      EMPLOYEE_HELPDESK: 88,
      RESEARCH_TOOLS_MANAGER: 89,
      SOCIAL_PLUGIN: 90,
      INSTAGRAM_AIRWAVE: 91,
      WEARABLES_USER_SITE: 92,
      BILLING_WIZARD: 93,
      AD_LIBRARY: 94,
    });
    f["default"] = a;
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      ...
      p = new RegExp("(^|\\\\.)meta\\\\.(com|ai)$", "i"),
      q = new RegExp("^(?:[^/]*:|[\\x00-\\x1f]*/[\\x00-\\x1f]*/)"),
      r = new RegExp(
        "[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]"
      ),
      s = c("UriNeedRawQuerySVConfig").uris.map(function (a) {
        return { domain: a, valid: z(a) };
      }),
      t = [],
      u = [];
    function v(a, b) {
      var d = {};
      if (a != null) for (a of a.entries()) d[a[0]] = a[1];
      else
    ...
    function A(a, b) {
      ...
      c = b.domain != null ? w(b.domain, c) : a.getSerializer();
      c = {
        domain: a.getDomain(),
    ...
    function B(a, b, c, d) {
      ...
      b = C(
        ...
        b,
        c,
        d != null ? d : a.serializer
      );
      c = b.length > 0 ? "?" : "";
      d = a.fragment !== "" ? "#" + a.fragment : "";
      a = a.fragment === "" && a.fragmentSeparator ? "#" : "";
      return "" + e + f + g + h + c + b + a + d;
    }
    function C(a, b, c, d, e, f) {
      e === void 0 && (e = !1);
      return !d && (e || x(a)) ? (b != null ? b : "") : v(c, f);
    }
    function D(a) {
      var b = a.trim();
    ...
    var F = (function () {
      ...
      a.getUribyObject = function (b, d) {
        var e = B(b, d),
          f = l.get(e);
        if (f == null) {
          d && (b.originalRawQuery = v(b.queryParams, b.serializer));
          d = E(b);
      ...
      b.removeSubdomain = function () {
        ...
        return A(a, { domain: b.join("."), subdomain: "" });
      };
      ...
      b.setDomain = function (a) {
        if (Boolean(a)) {
          var b = a.split(".");
          b = b.length >= 3 ? b[0] : "";
          return A(this, { domain: a, subdomain: b });
        }
        return this;
      };
      b.setFragment = function (a) {
        return a === "#"
          ? A(this, { fragment: "", fragmentSeparator: !0 })
          : A(this, { fragment: a, fragmentSeparator: a !== "" });
      };
      b.setPath = function (a) {
        return a != null ? A(this, { path: a }) : this;
      };
      b.setPort = function (a) {
        return Boolean(a) ? A(this, { port: a }) : this;
      };
      b.setProtocol = function (a) {
        return Boolean(a) ? A(this, { protocol: a }) : this;
      };
      ...
      b.setSubDomain = function (a) {
        if (Boolean(a)) {
          ...
          return A(b, { domain: c.join("."), subdomain: a });
        }
        return this;
      };
      ...
      a.$1 = function (a) {
        a = a;
        for (var b of t) a = b(a);
        return a;
      };
      a.$2 = function (a, b) {
        b = b;
        for (var c of u) b = c(a, b);
        return b;
      };
      b.$3 = function (b, c) {
        c === void 0 && (c = !1);
    ...
    f = F.getUri;
    var G = F.getUriOrThrow,
      H = F.isValidUri;
    g.isSubdomainOfDomain = y;
    g.isConstUri = a;
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function d(a) {
      (s = a.isValidElement),
        ...
        a.unstable_useContextWithBailout,
        a.useContext;
    }
    a = !1;
    function e(a, b) {
    ...
    var s = null;
    function t(a) {
      return (a = s == null ? void 0 : s(a)) != null ? a : !1;
    }
    var u = new Set();
          ...
          if (a === null || b === null)
            ...
            if (!(b instanceof Map)) i("Map instance", "other value", d, e);
              ...
              for (var f of a) {
                ...
                !b.has(g)
                  ? i(
                      "Map instance with key " + String(g),
                      "Map instance without key " + String(l),
                      d,
                      e
                    )
                  : k(l, b.get(g), d + ".get(" + String(g) + ")", e + 1);
              }
            ...
            if (!(b instanceof Set)) i("Set instance", "other value", d, e);
              ...
              for (l of b)
                a.has(l) ||
                  i(
                    "Set instance without element " + String(l),
                    "Set instance with element " + String(l),
                    d,
                    e
                  );
            ...
            !t(a) || !t(b)
              ? i(
                  "type " + (t(a) ? "React element" : "object"),
                  "type " + (t(b) ? "React element" : "object"),
                  d,
                  e
                )
              : c(
    ...
    function a(a) {
      ...
      Object.assign(b, {
        ReactCurrentDispatcher: {
          get current() {
            i("ReactCurrentDispatcher-current-get");
            return b.H;
          },
          set current(a) {
            i("ReactCurrentDispatcher-current-set"), (b.H = a);
          },
        },
        ReactCurrentCache: {
          get current() {
          ...
          set current(a) {
            i("ReactCurrentCache-current-set", "mustfix");
          },
        },
        ReactCurrentBatchConfig: {
          ...
          set transition(a) {
            i("ReactCurrentBatchConfig-transition-set", "mustfix");
          },
        },
        ReactCurrentOwner: {
          get current() {
            i("ReactCurrentOwner-current-get");
            var a = b.A;
      ...
      [
        ...
        var c;
        ((c = Object.getOwnPropertyDescriptor(b, a)) == null
          ? void 0
          : c.configurable) && Object.defineProperty(b, a, { enumerable: !1 });
      });
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    b("react-compiler-runtime").initReactCompilerRuntime(a);
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      ...
      j = -1,
      k = null;
    c("requireDeferred")("bumpVultureJSHash")
      .__setRef("vulture")
      .onReadyImmediately(function (a) {
        (k = a), u();
      });
    var l = !1,
      m = !1,
    ...
    function r(a) {
      var b = o.get(a);
      if (b === i || k == null) return;
      b == null
        ? k(a, 1)
        : b === j
        ? (k(a, 1),
          d("VultureJSGating").isLowVolumeLoggingEnabled() &&
            c("FBLogger")("vulture_js", "low_volume_" + a)
              .addToCategoryKey(a)
              .addMetadata("VULTURE_JS", "LOW_VOLUME_HASH", a)
              .warn("Low volume vulture with hash %s hit", a))
        : Math.floor(Math.random() * b) === 0 && k(a, b);
    }
    function s(a) {
      p.push(a);
    }
    function t() {
      n != null && (c("clearTimeout")(n), (n = null)), (m = !1), (l = !0), u();
    }
    function u() {
      if (l && k != null)
        while (p.length > 0) {
    ...
    function v() {
      ...
      (h || (h = c("ExecutionEnvironment"))).canUseDOM &&
        (n = c("setTimeout")(function () {
          t(),
            c("FBLogger")("vulture_js", "sample_rate_load_timeout").warn(
              "Timed out attemping to fetch VultureJS sample rates"
            );
        }, q));
      c("JSResource")("VultureJSSampleRatesLoader")
        .__setRef("vulture")
        .load()
        .then(
          (function () {
        ...
        ["catch"](function (a) {
          c("FBLogger")("vulture_js", "sample_rate_load_timeout")
            .catching(a)
            .mustfix("Failed to fetch sample rates:  %s", a.getMessage());
        })
        ["finally"](t);
    }
    function a(a) {
      d("VultureJSGating").isLoggingEnabled() &&
        (l && k != null ? r(a) : (s(a), v()));
    }
    g["default"] = a;
  },
